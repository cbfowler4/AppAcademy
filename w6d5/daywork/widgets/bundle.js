...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = [{ title: "tab1", content: "indian cuisine" }, { title: "tab2", content: "pizzzzaaaa cuisine" }, { title: "hotpockets", content: "lets get drunk" }];

  return _reactDom2.default.render(_react2.default.createElement(_root2.default, { tabs: tabs }), root);
});
...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
    key: 'activateTab',
    value: function activateTab(idx) {
      var _this2 = this;

      return function (e) {
        _this2.setState({ activeTab: idx });
      };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      // debugger
      var tabs = this.tabs.map(function (tab, idx) {
        return _react2.default.createElement(_tab2.default, {
          title: tab.title,
          content: tab.content,
          idx: idx,
          key: idx,
          selectedIdx: _this3.state.activeTab,
          activateTab: _this3.activateTab
        });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'marquee',
          { className: 'clock-marquee' },
          _react2.default.createElement(_clock2.default, null)
        ),
        _react2.default.createElement(
          'marquee',
          { direction: 'up', className: 'tabs-marquee', truespeed: '40', scrolldelay: '40' },
          _react2.default.createElement(
            'ul',
        ...
        _react2.default.createElement(
          'marquee',
          { direction: 'left', className: 'weather-marquee' },
...
var Tab = function Tab(_ref) {
  ...
  if (idx === selectedIdx) {
    ...
    return _react2.default.createElement(
      "li",
      { className: "tab", onClick: activateTab(idx) },
      _react2.default.createElement(
        "h1",
...
var Weather = function (_React$Component) {
  ...
  function Weather(props) {
    ...
    _this.state = { lat: null, long: null, state: null, city: null, weather: null, temperature_string: null };
  ...
  _createClass(Weather, [{
    ...
    value: function getPosition() {
      ...
      navigator.geolocation.getCurrentPosition(function (pos) {
        _this2.setState({ lat: pos.coords.latitude, long: pos.coords.longitude });
      });
    }
  }, {
    key: "fetchWeather",
    value: function fetchWeather(lat, long) {
      var that = this;
      ...
      return $.ajax({
        ...
        return $.ajax({
          ...
          var temperature_string = response.current_observation.temperature_string;

          that.setState({ city: city, state: state, weather: weather, temperature_string: temperature_string });
        });
      });
    }
  }, {
